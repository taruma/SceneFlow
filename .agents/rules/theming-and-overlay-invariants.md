...
- **App Shell Theme Selector**: The header's `[ ⚙️ Settings ▾ ]` dropdown houses a direct 4-option grid selector (`Auto`, `Light`, `Warm`, `Dark`) mapped directly to `setThemeMode` from `useAppShellTheme`.
