...
export const SCRIPT_STYLES = {
  ...
  stagingContainer: "flex items-center justify-center gap-1.5 lg:gap-2 mb-2 lg:mb-0",
  stagingBadgeBase: "flex items-center gap-1 lg:gap-1.5 px-2 py-0.5 lg:px-3 lg:py-1 rounded-full border border-stone-200 bg-white shadow-sm transition-all",
  ...
  stagingBadgeText: "text-[7.5px] lg:text-[9px] font-black uppercase tracking-wider lg:tracking-widest text-stone-500",
