...
export const SCRIPT_STYLES = {
  ...
  stagingBadgeBase: "flex items-center gap-1 lg:gap-1.5 px-2 py-0.5 lg:px-3 lg:py-1 rounded-full border border-stone-200 bg-white shadow-sm transition-all shrink-0",
