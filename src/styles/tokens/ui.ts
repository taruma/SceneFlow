/**
 * Reusable UI Chrome & Theme Swatch Design Tokens
 * Centralized Tailwind class bundles for uniform surfaces, buttons, modals, swatches, and badges.
 */
...
export const UI_TOKENS = {
  ...
  modal: {
    ...
    containerMd: "bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300",
