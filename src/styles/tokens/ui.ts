...
export const UI_TOKENS = {
  ...
  button: {
    ...
    segmentedGroup: "flex items-center bg-surface-muted p-0.5 lg:p-1 rounded-xl border border-border-main shadow-xs",
    segmentedItem: "flex items-center gap-1.5 px-2 lg:px-2.5 py-1 lg:py-1.5 rounded-lg text-[10px] lg:text-xs font-semibold text-text-muted hover:text-text-main hover:bg-surface/60 transition-all active:scale-95",
    segmentedItemActive: "flex items-center gap-1.5 px-2 lg:px-2.5 py-1 lg:py-1.5 rounded-lg text-[10px] lg:text-xs font-semibold bg-surface text-text-main shadow-xs transition-all",
    adaptiveModeToggle: "flex items-center gap-1.5 px-2.5 lg:px-3 py-1.5 rounded-xl text-[10px] lg:text-xs font-bold transition-all border shadow-xs active:scale-95",
    settingsPill: "flex items-center gap-1.5 px-2.5 lg:px-3 py-1.5 bg-surface hover:bg-surface-subtle text-text-body hover:text-text-main rounded-xl text-[10px] lg:text-xs font-bold transition-all active:scale-95 border border-border-main shadow-xs",
    settingsPillActive: "flex items-center gap-1.5 px-2.5 lg:px-3 py-1.5 bg-surface-muted text-text-main rounded-xl text-[10px] lg:text-xs font-bold transition-all active:scale-95 border border-border-main shadow-inner",
    filePill: "flex items-center gap-1.5 px-2.5 py-1.5 bg-surface hover:bg-surface-subtle text-text-body hover:text-text-main rounded-xl text-xs font-bold transition-all active:scale-95 border border-border-main shadow-2xs",
    filePillActive: "flex items-center gap-1.5 px-2.5 py-1.5 bg-surface-muted text-text-main rounded-xl text-xs font-bold transition-all active:scale-95 border border-border-main shadow-inner",
    libraryPop: "flex items-center gap-1.5 px-2.5 lg:px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all active:scale-95 border shadow-xs bg-surface hover:bg-surface-hover text-text-main border-border-main hover:border-border-hover",
    libraryPopActive: "bg-btn-primary-bg text-btn-primary-text border-btn-primary-bg shadow-md",
