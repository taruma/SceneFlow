...
export const EXTERNAL_LINKS = {
  ...
  github: 'https://github.com/taruma/SceneFlow',
  docs: 'https://github.com/taruma/SceneFlow#readme',
  changelog: 'https://github.com/taruma/SceneFlow/blob/main/CHANGELOG.md',
  author: 'https://linktr.ee/tarumainfo',
} as const;
